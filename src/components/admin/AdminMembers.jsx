  ...
  return (
    <div className="flex-1 my-12 mx-20 flex">
      <div className="p-4 w-1/3 flex flex-col items-center">
        ...
        <h1 className="text-yellow-500 text-center text-3xl font-bold pt-4 pb-1">
          Shashank Jaiswal
        </h1>
      ...
      <div className="p-4 w-2/3 grid grid-cols-2">
        <div>
          ...
          <h2 className="text-white text-xl italic">2020</h2>
          <br />
        </div>
        <div>
          ...
          <h2 className="text-white text-xl italic">Web Developer</h2>
          <br />
        </div>
        <div>
          <h1 className="text-white text-2xl font-semibold underline">
          ...
          <h2 className="text-white text-xl italic">Web Development</h2>
          <br />
        </div>
        <div>
          ...
          <h2 className="text-white text-xl italic">
            ...
            commodi ad necessitatibus ex eius. Corrupti ullam alias blanditiis
            fugit iste.
          </h2>
          <br />
        </div>
        <div>
          ...
          <h2 className="text-white text-xl italic">shashank@gmail.com</h2>
          <br />
        </div>
        <div>
          <h1 className="text-white text-2xl font-semibold underline">
          ...
          <h2 className="text-white text-xl italic">www.sjlinkedin.com</h2>
          <br />
        </div>
        <div>
          <h1 className="text-white text-2xl font-semibold underline">
          ...
          <h2 className="text-white text-xl italic">www.sjinsta.com</h2>
          <br />
        </div>
        <div>
          <h1 className="text-white text-2xl font-semibold underline">
          ...
          <h2 className="text-white text-xl italic">www.sjgithub.com</h2>
          <br />
        </div>
        <div className="flex space-x-4 col-span-2 justify-end">
          <Link className="text-white" onClick={() => setShowModal(true)} to="">
